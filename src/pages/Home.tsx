...
export default function Home() {
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top_left,_#FFF7ED_0%,_#FDF2F8_40%,_#F5F3FF_100%)]">
      <div className="pointer-events-none fixed inset-x-0 top-0 h-[420px] opacity-60"
        style={{
          background:
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 py-6 sm:px-6 lg:px-8">
        <header className="mb-6 flex flex-col items-start justify-between gap-4 border-b border-zinc-200/60 pb-6 sm:flex-row sm:items-center">
          <div className="flex items-center gap-3">
            <div
              className="flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 via-pink-500 to-purple-600 text-2xl shadow-lg shadow-pink-500/30">
            ...
            <div>
              <h1 className="text-2xl font-black text-zinc-900 sm:text-3xl"
                ...
                欢乐机制本 · 一分钟组局海报生成器 <PartyPopper className="ml-1 inline h-7 w-7 -translate-y-1 text-pink-500" />
              </h1>
        ...
        <footer className="mt-10 border-t border-zinc-200/60 pt-6 text-center text-xs text-zinc-500">
          ...
          <p className="opacity-60">海报仅在本地生成，不上传任何数据，放心使用～</p>
        </footer>
      </div>
    </div>
  );
